...
export default function NewHeader() {
    ...
    return (
        <header className="w-full flex justify-between items-center bg-[#FFF6EB] px-6 py-4 ">
            ...
            {/* MUST ANY SUBPAGE MUST GO BACK TO CORRECT ENDPOINT (/brewer/dashboard or /user/dashboard) */}
            <Link to={`/brewer/dashboard/${userId}`} className="flex items-center space-x-3">
                <img
                    src={bp_logo}
                    alt="BrewPalate Logo"
