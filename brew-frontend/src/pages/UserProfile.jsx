    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="w-full max-w-screen-md mx-auto px-4 py-6">
        {userProfile ? (
          <div className="w-full bg-[#f2f2f2] overflow-hidden border border-slate-200 shadow-sm transition-all p-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-[#8C6F52]">Your Profile</h2>
            ...
            {isEditing ? (
              <div className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-xl px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-[#3C547A]/40"
                ...
                <div className="flex flex-wrap gap-3 !items-center justify-center">
                  <button
                    className="bg-[#3C547A] hover:bg-[#314466] text-white px-4 py-1 rounded-full font-semibold transition-colors"
                    onClick={updateUserProfile}
                  >
                    Save
                  </button>
                  <button
                    className="bg-white text-[#8C6F52] border border-[#8C6F52]/40 px-5 py-2 rounded-xl font-semibold hover:bg-[#dbdbdb] transition-colors"
              ...
              <div className="space-y-4 text-slate-900">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="bg-white border-slate-200 border rounded-xl px-3 py-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="bg-white border-slate-200 border rounded-xl px-3 py-2 break-all">
                      {userProfile.email || '—'}
                    </div>
                  </div>
                ...
                <div className="flex !items-center justify-center gap-2 pt-2">
                  ...
                  <button
                    className="bg-white text-[#8C6F52] border border-[#8C6F52]/40 px-4 py-2 rounded-xl font-semibold hover:bg-[#dbdbdb] transition-colors"
                    onClick={async () => {
          ...
          <div className="text-[#8C6F52] text-lg text-center">Loading profile...</div>
        )}
      </div>
    </div>
  );
