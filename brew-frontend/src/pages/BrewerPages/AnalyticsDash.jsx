    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                //     `${BASE_URL}/api/brewer/analytics/${brewerId}`,
                //     { headers: { Authorization: `Bearer ${token}` } }
                // );
        ...
        fetchData();
    }, [BASE_URL, token, brewerId, isAuthorized]);
        ...
        <div className="min-h-screen w-full overflow-x-hidden bg-[#fff4e6] flex flex-col
            ...
            <div className="flex flex-col gap-5 w-full p-5">
                <section className="w-full bg-white p-4 rounded-2xl overflow-hidden border shadow-md transition-all">
                    ...
                    <p className="text-gray-600">Brewer ID: <strong>{brewerId}</strong></p>
                        ...
                        <div className="mt-4">
                            ...
                            {status.brewery && (
                                <p className="text-gray-600">
                                    Brewery: <strong>{status.brewery.breweryName}</strong>
                                </p>
                            )}
                        </div>
                    )}
