...
export default function About() {
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-white flex flex-col border-[#6E7F99]
      ...
      <main className="w-full max-w-screen-xl mx-auto flex flex-col gap-4">
        ...
        <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center">
          ...
          {/* Static founder info – replace with your own details */}
          ...
          {/* Simple inquiry form (front-end only for now) */}
